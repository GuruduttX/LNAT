...
const stats = [
  { icon: Trophy, value: 6, suffix: "X+", label: "Years of Excellence in Law Entrance Coaching" },
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-10 items-center">
          <div>
            ...
            <p className="font-body text-gray-500 mb-6 text-sm md:text-[15px]">
              Join the LNAT coaching institute trusted by thousands of aspirants across Delhi NCR.
            </p>
            <Button
              onClick={() =>
