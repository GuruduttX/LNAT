...
const CoursesSection = () => {
  ...
  const filtered =
    tab === "bestselling" ? lnatCourses.filter((c) => c.bestselling) : lnatCourses;
          ...
          {filtered.map((c, i) => (
            ...
            >
              ...
              <div className="sm:w-44 md:w-52 shrink-0 relative overflow-hidden" style={{ minHeight: "140px" }}>
                ...
                {/* Discount badge */}
                <span
                  className="absolute top-2 left-2 bg-accent text-gray-900 font-black px-2 py-0.5 text-[10px] z-10"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black/50 py-1.5 px-3 z-10">
                  <p className="text-white text-center font-black leading-tight" style={{ fontSize: "1.1rem" }}>LNAT {c.year}</p>
