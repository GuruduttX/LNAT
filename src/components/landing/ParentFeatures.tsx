...
const features = [
  { icon: ClipboardList, title: "Mock Test Insights", text: "Detailed LNAT performance reports", color: "bg-orange-100 text-orange-600" },
  { icon: UserCheck, title: "Personalized Teacher Feedback", text: "Section-wise feedback on MCQs and essays", color: "bg-green-100 text-green-600" },
  { icon: FileText, title: "Exclusive Mentorship Reports", text: "LNAT student insights", color: "bg-purple-100 text-purple-600" },
    ...
    <section className="py-14 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="font-body text-gray-500 text-center mb-10 text-sm md:text-[15px]">
          Stay connected with your child's LNAT preparation journey
        </p>
