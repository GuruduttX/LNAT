      ...
      >
        <div className="grid lg:grid-cols-[1fr_420px] gap-10 xl:gap-16 items-center">
          ...
          <div className="space-y-6 max-w-2xl">
            ...
            >
              🏆 India's #1 LNAT Coaching | Delhi NCR
            </motion.div>
            ...
            >
              Best LNAT Coaching<br className="hidden sm:block" /> in Delhi NCR
            </motion.h1>
            ...
            >
              Planning to pursue a Law degree from top UK and international universities like
              Oxford, Cambridge, UCL, or LSE? Start your preparation with Law Prep Tutorial
              experienced faculty, structured curriculum, and guaranteed results.
            </motion.p>
