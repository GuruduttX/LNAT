      ...
      <div className="container mx-auto px-4 py-10 md:py-16 lg:py-20">
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-5">
            ...
            >
              Best LNAT Coaching in Delhi NCR
            </motion.h1>
            ...
            >
              Planning to pursue a Law degree from top UK and international universities like Oxford, Cambridge, UCL, or LSE? Start your preparation with Law Prep Tutorial — experienced faculty, structured curriculum, and guaranteed results.
            </motion.p>
